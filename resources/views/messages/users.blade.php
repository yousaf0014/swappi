			       ...
			       <div class="karsten_profile" data-name="{{ strtolower($message->fName) }} {{ strtolower($message->lName) }}">
			       	...
			       	<a class="msg-user pull-left" href="{{ url('message/user/' . $message->id) }}" data-userid="{{ $message->id }}">
				        ...
				        <div class="col-md-8 col-sm-8 col-xs-12 padd_ina_rosen_section_right">
				        	...
				        	<span>{{ str_limit($message->pivot->msgText,15) }}</span>
				        	<div class="msg-user-businessline hide">{{ $message->businessLine }}</div>
				        </div>
				        <div class="col-md-2 col-sm-2 col-xs-12">
				        	<p>
				        		@if($message->pivot->isUnread)
				        		<img src="images/right_icon_karsten.png">
				        		@endif
				        	</p>
				        </div>
				   	</a>
	      ...
	      <div class="col-md-6 col-sm-6 col-xs-12 ">
	        ...
	        <div class="torben_nielson_section" id="msg-box-user">
	          <div class="col-md-1 col-sm-1 col-xs-12">
	           <img width="48" class="img-circle" src="{{ asset('uploads/default-avatar-270x270.png') }}">
	          </div>
	          ...
	          <div class="col-md-3 col-sm-3 col-xs-12">
	           <a href="javescript:;" data-href="{{ url('message/unread/') }}" class="unread-msg" data-userid=""><h2>Marker som ulæst</h2></a>
	           <a href="javescript:;" data-href="{{ url('message/delete/') }}" class="delete-msg" data-userid=""><h2>Slet besked</h2></a>
	          </div>
	        </div>
