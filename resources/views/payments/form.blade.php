...
<body>
	<center>
		<form id="checkout-form" class="form-horizontal" action="pay" method="post">
			{{ csrf_field() }}
		  <div class="form-cell">
		    <label for="name">Name</label>
		    <input type="text" name="name" value="">
		  </div>
		  <div class="form-cell no-margin">
	...
	<style type="text/css">
	  ...
	  #checkout-form div.form-cell {
	      float: left;
	      width: 200px;
	      margin: 0 45px 15px 0;
	  }
	  #checkout-form div.form-cell.no-margin {
	      margin-right: 0;
	  }
