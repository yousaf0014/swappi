			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="col-md-4 col-sm-4 col-xs-12 tv_dr_Presseomtale">
						...
						<span>Kilde : TV2</span>
						<h4><a href="http://www.dr.dk/" target="_blank">Læs opslaget</a></h4>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12 tv_dr_Presseomtale">
						...
						udviklet af Swappi</h2>
						<span>Kilde : DR1</span>
						<h4><a href="http://www.tv2.dk/" target="_blank">Læs opslaget</a></h4>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12 tv_dr_Presseomtale">
						...
						udviklet af Swappi</h2>
						<span>Kilde : DR1</span>
						<h4><a href="http://www.eb.dk" target="_blank">Læs opslaget</a></h4>
					</div>
