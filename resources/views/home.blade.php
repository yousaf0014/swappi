<!DOCTYPE html>
	...
	<html lang="en">
	  ...
	  <head>
		...
		@if(Auth::check())
        	...
        	<style>
				...
				/*@media (max-width: 767px) {
					...
					#image-slider{height:705px;}
				}*/

				.header_profile_left .nav.navbar-nav a {
				    color: #8f8f8c;
				    margin-right: 10px;
				    font-size: 14px;
				    padding: 5px 10px;
		...
		@else
			<style type="text/css">
				.header-affix.affix .navbar.navbar-inverse{
					padding-bottom: 20px;
				} 
				.header-affix.affix .nav.navbar-nav{
					    margin-top: 30px;
				}
				.header-affix.affix .navbar-inverse .navbar-nav > li > a{
				    margin-right: 10px;
				    font-size: 14px;
				    padding: 5px 10px;
				    font-family: 'Lato-Bold';
				}
				.header-affix.affix .navbar-inverse .navbar-nav > li > a:hover{
					margin-top:0px;
				}
			</style>
        @endif
	 		...
	 		<div class="wrapper">
	 			...
	 			<div class="header">
				   ...
				   <div class="container-fluid" style="position: relative;top: -81px;">
				    ...
				    <div class="row col-md-12" style="margin-left: -2%;">
				     ...
				     <div class="col-md-12 col-sm-12 col-xs-12 container_slider">
				      ...
				      <div class="col-md-7 col-sm-7 col-xs-12 container_slider_right @if(Auth::check()) loggedin_right @endif">
				       ...
				       <div class="header_right">
					       ...
					       <div id="image-slider" class="carousel home-carousel slide" data-ride="carousel">
							  ...
							  <div class="carousel-inner" role="listbox">
							    ...
							    <div class="item active">
							    	...
							    	<div style="background: url({{ asset('images/slide0.png') }});background-repeat: no-repeat;background-size: cover;height: 555px;background-position: 100%;" onclick="$('#videoModal').modal('show')">
                                    <div style="padding-top: 30% !important;">
							    		<div style="margin-left: 20%;" class="btn-link" onclick="$('#videoModal').modal('show');">

							    			<img style="width: 50px;height: 50px;" src="{{ asset('images/play-icon.png') }}"> <span style="color: #ffffff;">Sådan virker det</span>
								 ...
								 <div class="item">
							    	...
							    	<div style="background: url({{ asset('images/slide1.png') }});background-repeat: no-repeat;background-size: cover;height: 555px;background-position:100%;" onclick="$('#videoModal').modal('show')">
							    ...
							    <div class="item">
							    	...
							    	<div style="background: url({{ asset('images/slide2.png') }});background-repeat: no-repeat;background-size: cover;height: 555px;background-position: 100%" onclick="$('#videoModal').modal('show')">
                                        <div style="padding-top: 30% !important;">
                                        <div style="margin-left: 20%;" class="btn-link" onclick="$('#videoModal').modal('show');">
								...
								<div class="item">
							    	...
							    	<div style="background: url({{ asset('images/slide3.png') }});background-repeat: no-repeat;background-size: cover;height: 555px;background-position: 100%" onclick="$('#videoModal').modal('show')">
                                    <div style="padding-top: 30% !important;">
	                                <div style="margin-left: 20%;" class="btn-link" onclick="$('#videoModal').modal('show');">
						...
						<div class="modal fade" id="videoModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="z-index:2147483647;">
	...
	font-size: 16px;">
										...
										<div class="embed-responsive embed-responsive-16by9">
											<video id="myvideo" width="100%" height="500" controls>
												<source src="{{asset('uploads/main_swappi_finver.1.mp4')}}" type="video/mp4">							
					     	...
					     	@foreach($featuredAds as $ad)
				     		  ...
				     		  <div class="col-md-6 col-sm-6 col-xs-12">
						        ...
						        <div class="col-md-6 col-sm-6 col-xs-12 Udvikling_Fotograf_left">
						        	...
						        	<a href="{{ url('ad/' . $ad->id . '/detail') }}"><img height="270" src="{{ asset(Croppa::url('/uploads/' . returnFeaturedImage($ad->adimages), 270, 270)) }}" width="100%" /></a>
 ...
 -->
		...
		<div id="about" class="modal fade" role="dialog" style="z-index:2147483647;">
	...
	font-size: 16px;"><i class="fa fa-times-circle"></i></button>
		...
		<div id="Tilfredsbarometer" class="modal fade" role="dialog" style="z-index:2147483647;">
