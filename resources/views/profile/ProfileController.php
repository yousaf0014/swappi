...

{
	...
	public function experienceSave(Request $request) {
		...
		$data['end_date_identifier'] = $request->input('edi') != '' ? $request->input('edi') : $request->input('edi_new') != '' ? $request->input('edi_new') : 0;

		if ($data['end_date_identifier'] == 1) {
			$data['endDate'] = '00-00-0000 00:00:00'
		}
