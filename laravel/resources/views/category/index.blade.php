		       	...
		       	<form method="get" action="">
					...
					<div class="advocate_category btn-group">
						<p class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				         	...
				         	<label style="font-size:13px;">{{ $allCount }} tilgængelig</label>
				         	<img src="{{ asset('images/vector_ad_icon.png') }}">
				        </p>
		            ...
		            <div class="table-responsive">          
		              <table class="table" id="ads-table">
		                ...
		                <tbody id="ajax_filter">
		                	@forelse($ads as $ad)
								<tr class="{{$ad->transactions[0]->txnType}}">
									...
									<td>
				                    	...
				                    	<p class="text-capitalize label label-primary label-lg" style="padding: 3px 6px;font-weight: 100; letter-spacing: 0.7px;bottom: -41px;position:relative;"> 
			                ...
			                @empty
			                	<tr><td colspan="3" align="center">Der er ingen annoncer tilgængelige</td></tr>
			                @endforelse
