							  ...
							  <div class="carousel-inner" role="listbox">
							    ...
							    <div class="item active">
								 ...
								 <div class="item">
							    	...
							    	<div style="background: url({{ asset('images/slide1.png') }});background-repeat: no-repeat;background-size: cover;height: 555px;background-position:100%;">
							    ...
							    <div class="item">
							    	...
							    	<div style="background: url({{ asset('images/slide2.png') }});background-repeat: no-repeat;background-size: cover;height: 555px;background-position: 100%">
								...
								<div class="item">
							    	...
							    	<div style="background: url({{ asset('images/slide3.png') }});background-repeat: no-repeat;background-size: cover;height: 555px;background-position: 100%">
