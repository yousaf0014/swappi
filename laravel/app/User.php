...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'fName', 'lName','username', 'email', 'password', 'phone1', 'phone2', 'country', 'city', 'postCode', 'profileType', 'jobTitle', 'businessLine', 'businessLink', 'description', 'profilePic', 'coverPic', 'created_timestamp'
    ];
    ...
    {
        return $this->belongsToMany(Skill::class, 'skill_endorsments', 'to_user', 'skill_id');
    }
    ...
    function messagesOfMine()
    {
    	return $this->belongsToMany(User::class, 'messages', 'sender_id', 'reciever_id')
    		...
    		->withPivot('msgText')
    		->withPivot('isUnread')
    		->withPivot('createdAt')->orderBy('pivot_createdAt', 'DESC');
